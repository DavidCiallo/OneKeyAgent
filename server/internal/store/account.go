...
var updatable = map[string][]string{
	...
	"provider": {"model_alias", "priority", "name", "base_url", "model", "api_key", "auth_type", "api_type", "proxy_url", "supports_thinking", "supports_reasoning_effort", "replay_reasoning", "enable_search", "extra_json", "enabled", "max_context", "daily_quota"},
	"role":     {"name", "type"},
	"settings": {"key", "value"},
